  ...
  return (
    <div className="emissions-wrapper">
      <div className="emissions-header">
        ...
        <img
          className="emissions-logo"
          src="../../images/shire.png"
          alt="shire-logo"
        />
      </div>
      <div className="emissions-subheader">
        <h2 className="emissions-subtitle">Looking Behind</h2>
        <p className="emissions-nar">
          To move forward we need to see where we have been. Submiting this form
          will give you a baseline of your yearly C0<sub>2</sub> emssions
        </p>
      </div>
      <div className="emissions-body">
        <form className="emissions-form">
          <fieldset className="emissions-field" name="home">
            <h3>Home</h3>
            <input
              className="input-orange home-input"
              type="number"
            ...
            <input
              className="input-orange home-input"
              type="number"
              placeholder="Avg. $/Monthly: Electric"
              required={true}
              onChange={e => setElectric(parseInt(e.target.value))}
            />
            <input
              className="input-orange home-input"
              type="number"
              placeholder="Avg. $/Monthly: Natural Gas"
              required={true}
              onChange={e => setNaturalGas(parseInt(e.target.value))}
            />
            <input
              className="input-orange home-input"
              type="number"
              placeholder="Avg. $/Monthly: Propane"
              required={true}
              onChange={e => setPropane(parseInt(e.target.value))}
            />
            <input
              className="input-orange home-input"
              type="number"
              placeholder="Avg. $/Monthly: Fuel Oil"
              required={true}
              onChange={e => setFuelOil(parseInt(e.target.value))}
            />
          </fieldset>
          <fieldset className="emissions-field" name="vehicles">
            <h3>Vehicle</h3>
            <div className="vehicle-btn-wrapper">
              <button className="btn-hz-green" onClick={e => addVehicle(e)}>
                ADD VEHICLE
              </button>
            </div>
              ...
              return (
                <fieldset className="vehicle-field" key={idx}>
                  ...
                  <input
                    ...
                    type="number"
                    name="mpg"
                    placeholder="avg. Miles Per Gallon"
                    onChange={e => handleVehicleMPG(e, idx)}
                  />
                  <input
                    className="input-orange"
                    type="number"
                    name="mpw"
                    placeholder="avg. Miles Per Week"
                    onChange={e => handleVehicleMPW(e, idx)}
                  />
                </fieldset>
              );
            })}
          ...
          <button id="emissions-submit" className="btn-hz-green" onClick={handleSubmit}>
            Shire
          </button>
        </form>
      </div>
