...
// the breakup of your carbon emissions
  ...
  return (
    <div className="shire-wrapper">
      <div className="shire-body">
        {totalEmissions() > 47399 && (
          <h2 className="shire-emissions-orange">
            {`${totalEmissions()}lbs C0`}
            <sub>2</sub>
          </h2>
        )}
        {totalEmissions() < 47399 && (
          <h2 className="shire-emissions-green">
            {`${totalEmissions()}lbs C0`}
            <sub>2</sub>
          </h2>
        )}
        ...
        {totalEmissions() > 47399 && (
          <p className="shire-result">
            {totalEmissions() - 47399}lbs over US National Avg
          </p>
        )}
        {totalEmissions() < 47399 && (
          <p className="shire-result">
            {totalEmissions() - 47399}lbs under US National Avg
          </p>
        )}
        ...
        <span className="shire-info">
        Year-round Tree debt: {Math.round(totalEmissions() / 48)} 
        </span>
      </div>
    </div>
  );
